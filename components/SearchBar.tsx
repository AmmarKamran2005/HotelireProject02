          ...
          <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#e5e5e5] rounded-md shadow-lg max-h-[300px] overflow-y-auto z-50">
            {filteredCities.slice(0, 10).map((city) => (
              <button
                ...
                className="w-full text-left px-4 py-2 hover:bg-[#f5f6fd] [font-family:'Poppins',Helvetica] text-sm text-[#3f2c77] transition-colors duration-200"
        ...
        <Popover open={isGuestsOpen} onOpenChange={setIsGuestsOpen}>
          ...
          <PopoverContent className="w-[280px] p-4" align="start">
            <div className="space-y-4">
              ...
              <Button
                className="w-full bg-[#3f2c77] hover:bg-[#2a2158] text-white"
