  ...
  return (
    <div className="bg-white w-full min-w-[1440px] flex flex-col">
      ...
      <nav className="w-full bg-white h-[111px] flex items-center justify-between px-[103px] relative">
        ...
        <div className="absolute top-[49px] right-[116px] w-[131px] bg-[#f5f6fdf0] rounded-[0px_0px_4px_4px] p-4 shadow-md">
          <div className="[font-family:'Poppins',Helvetica] font-medium text-[#3f2c77] text-[11px] leading-[30px]">
            My Account
            <br />
            My Trips
            <br />
