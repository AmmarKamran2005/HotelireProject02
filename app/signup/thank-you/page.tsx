    ...
    <AuthLayout>
      <div className="space-y-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="[font-family:'Poppins',Helvetica] text-2xl font-bold" style={{ color: "#3F2C77" }}>
            Hotelire
          </p>
        </div>
        ...
        <div className="pt-6">
          ...
          <h1 className="mt-6 text-center [font-family:'Poppins',Helvetica] text-2xl lg:text-3xl font-bold text-[#41C23B]">
            Thank you for signed up
          </h1>
          <p className="mt-3 text-center [font-family:'Inter',Helvetica] text-gray-600">
          ...
          <div className="mt-8 flex justify-center">
            <Link 
              href="/signin" 
              className="px-5 py-2 rounded-md text-white [font-family:'Poppins',Helvetica] transition-colors duration-200 hover:bg-[#2a2158]" 
